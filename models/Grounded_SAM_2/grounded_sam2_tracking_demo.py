...
original_video_path = "../../debug/rerender/refer_h4_A_man_is_walk,_against_a_pristine_white_background,_rotating_camera/raw_0.mp4"
...
for frame_idx, segments in video_segments.items():
    ...
    object_ids = object_ids[:1] # top one object
    masks = list(segments.values())
    masks = masks[:1] # top one object
